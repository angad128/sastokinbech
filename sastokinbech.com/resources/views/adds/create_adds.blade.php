...
@if(count($errors)>0)
	...
	<div class="container" style="margin-top: 20px; ">
		<div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <a href="{{ route('adds.view_adds')}}" class="pull-right btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i> View Your Adds</a>
    </div>
	</div>
    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
           <h3>Create Adds</h3>
    ...
    <br>
    <form action="{{route('adds.postadds')}}" method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<select id="category" class="form-control" name="category" onchange="populate(this.id,'subcategory')">
					<option></option>
			...
			<div class="form-group">
				...
				<textarea class="ckeditor" type="text" id="description" name="description"></textarea>
			</div>
			<div class="form-group">
				<label for="email">Photo 1:</label>
				<input class="form-control" type="file" id="title" name="image">
			</div>
			<div class="form-group">
				<label for="email">Photo 2</label>
				<input class="form-control" type="file" id="title" name="image2">
			</div>
			<div class="form-group">
				<label for="email">Photo 3</label>
				<input class="form-control" type="file" id="title" name="image3">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="price">Price<small style="font-style: italic;">(in Ruppes)</small></label>
				<input class="form-control" type="text" id="price" name="price">
			</div>
			<div class="form-group">
				<input type="hidden" name="user_id" value="<?=$_SESSION["user_data"]["user_id"];?>">
